...
pygame.init()
screen = pygame.display.set_mode((1000, 700)) #screen size and creats window
pygame.display.set_caption("Last Defender") #title at top
...
while running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            running = False
            screen.fill((0, 0, 0))
#creating a list of stars with random positions           
